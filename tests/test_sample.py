...
def test_filter():
    a: list[str] = []
    tester = [['投資候補：'], [], [], ['含', '売', 'ティッカー'], ['o', '', '8591'], ['x', '', '1605'], ['x', '', '1719'], ['x', '', '1928'], ['x', '', '1951'], ['x', '', '2154'], ['x', '', '3003'], ['x', '', '3176'], ['x', '', '3280'], ['x', '', '3431'], ['x', '', '4093'], ['x', '', '4202'], ['x', '', '4503'], ['x', '売', '4668'], ['x', '売', '4745'], ['x', '', '5105'], ['x', '', '5288'], ['x', '', '5334'], ['x', '', '5401'], ['x', '', '5406'], ['x', '', '5411'], ['x', '', '5911'], ['x', '', '6089'], ['x', '', '6223'], ['x', '', '6248'], ['x', '', '6301'], ['x', '', '6432'], ['x', '', '7148'], ['x', '', '7164'], ['x', '', '7246'], ['x', '', '7267'], ['x', '', '7272'], ['x', '', '7414'], ['x', '', '7438'], ['x', '', '8002'], ['x', '', '8014'], ['x', '', '8020'], ['x', '', '8031'], ['x', '', '8058'], ['x', '', '8058'], ['x', '', '8098'], ['x', '', '8306'], ['x', '', '8309'], ['x', '', '8316'], ['x', '', '8425'], ['x', '', '8439'], ['x', '', '8473'], ['x', '', '8566'], ['x', '', '8584'], ['x', '', '8593'], ['x', '', '8593'], ['x', '', '8596'], ['x', '', '8630'], ['x', '', '8725'], ['x', '', '8750']]
    for i in tester:
...
def test_gspread():
    ...
    gc = gspread.oauth(
        credentials_filename="/workspaces/gspread_client_secret.json"
    )
